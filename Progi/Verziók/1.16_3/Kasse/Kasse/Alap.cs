...
namespace Kasse
{
    public partial class Alap : Form
    {
        ...
        public class AdatbázisQleDb
        {
            ...
            public void Termékfelvitel(string Vonalkod, string Gyorskód,string Név, string Szállító, string Kategória, int Menny_érték, string Menny_egység, string Eladási_ár, string Nettó, string Akció, DateTime dateTime, bool Felnőt,string Áfa)
            {
                try
                {
                    conn.Open();
